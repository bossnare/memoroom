...
export const Tab = ({
  ...
  const defaultClass =
    'relative transition-colors overflow-hidden duration-300 md:duration-100 ease-in-out active:bg-muted-foreground/20 flex items-center justify-center md:justify-start md:rounded-sm w-full cursor-pointer gap-3 p-3 md:px-2 md:h-9 ease-in-out';
  const inactiveClass =
    'font-medium rounded-full md:hover:opacity-80 text-muted-foreground md:text-current md:hover:bg-muted';
